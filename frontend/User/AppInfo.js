    ...
    return (
        <View style={styles.container}>
            <View style={styles.content}>   
                ...
                <Text style={[styles.info, {width: 330, height: 170, fontSize:18}]}>
                ...
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    ...
                    <Text style={styles.listItem}>{"3. Daily Schedule: \nYour personalised daily schedule displays all your medications categorized by the time of day – morning, afternoon, and evening. Each medication is represented by a checkbox, allowing you to easily track your dosage intake."}</Text>
                    ...
                    <Text style={[styles.buttoninfo, {marginLeft: 20, width: 320, height: 110}]}>{"Thank you for choosing MediMeter to manage your medication!"}</Text>
                </ScrollView>
            </View>
        </View>
    );
